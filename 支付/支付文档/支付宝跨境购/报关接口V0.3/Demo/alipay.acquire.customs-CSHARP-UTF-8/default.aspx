        ...
        <div id="main">
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDmerchant_customs_code" name="WIDmerchant_customs_code" runat="server"></asp:TextBox>
                        <span></span>
                    </dd>
                    <dt>商户海关备案名称：</dt>
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDmerchant_customs_name" name="WIDmerchant_customs_name" runat="server"></asp:TextBox>
                        <span></span>
                    </dd>
                    <dt>报关金额：</dt>
                    <dd>
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDcustoms_place" name="WIDcustoms_place" runat="server"></asp:TextBox>
                        <span></span>
                    </dd>
                    <dt></dt>
                    <dd>
