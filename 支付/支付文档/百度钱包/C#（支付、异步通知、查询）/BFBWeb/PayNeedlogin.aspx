<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PayNeedlogin.aspx.cs" Inherits="BFBWeb.PayNeedlogin" %>
...
后台通知地址(return_url): 
<input type="text" id="return_url_f"  value="http://113.47.215.47:81/NotifyUrl.aspx" runat="server"/>*必填<br/>
前台通知地址(page_url): <input type="text" id="page_url_f" value="http://172.22.154.29:81/PageUrl.aspx" runat="server" /><br/>
