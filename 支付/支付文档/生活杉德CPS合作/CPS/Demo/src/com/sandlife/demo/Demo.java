...
public class Demo {
     ...
     public static void main(String[] args) throws Exception {
    	...
    	StringBuffer sbf = new StringBuffer();
  		...
  		sbf.append("&signType=").append("RSA")
  		   .append("&sign=").append(URLEncoder.encode(URLEncoder.encode(sign,"UTF-8"),"UTF-8"));  //签名串URLEncoder下防止 “+”等字符自动转码
     ...
     public static void Test1() 
     {
         ...
         jz.signByPrivateKeyPem("content", "privateKeyPath.pem");    // content 签名内容   privateKeyPath 私钥路径 
