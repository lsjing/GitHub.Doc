...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        //1、取得委托扣款解约请求所需要的信息
        //2、生成委托扣款解约请求对象
        com.hitrust.trustpay.client.b2c.B2CAgentUnsignContractRequest tRequest = new com.hitrust.trustpay.client.b2c.B2CAgentUnsignContractRequest();
...
<head>
    <title>农行网上支付平台-商户接口范例-委托扣款解约</title>
</head>
