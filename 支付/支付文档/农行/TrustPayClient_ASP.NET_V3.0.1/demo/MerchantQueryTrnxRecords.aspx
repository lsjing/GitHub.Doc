...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        if (ReturnCode.Equals("0000"))
        {
            ...
            strMessage.Append("ZIPDetailRecords      = [" + JSON.GetKeyValue("ZIPDetailRecords") + "]<br/>");//请求报文指定压缩时该字段有值
            strMessage.Append("DetailRecords      = [" + JSON.GetKeyValue("DetailRecords") + "]<br/>");//请求报文不指定压缩时该字段有值
