        ...
        <table>
            ...
            <tr>
             ...
             <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtInstallment' Text='1' />1：分期；0：否。*必输</td>
            </tr>
            <tr>
                <td>分期代码
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtProjectID' Text='4555' />选输</td>
            </tr>
            <tr>
                <td>分期期数
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtPeriod' Text='10' />选输</td>
            </tr>
            <tr>
                <td>支付账户类型
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtPaymentType' Text='3' />1：农行卡支付 3：农行贷记卡支付 *必输</td>
            </tr>
            <tr>
                <td>交易渠道
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtIsBreakAccount' Text='1' />0:否；1:是，*必输</td>
            </tr>            
			 <tr>
                <td>分账模版编号</td>
                <td>
