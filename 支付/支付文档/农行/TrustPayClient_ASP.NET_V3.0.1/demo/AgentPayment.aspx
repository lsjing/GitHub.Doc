    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtCardNo' Text='1' />选输</td>
            </tr>   
             <tr>
                <td>交易币种
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtFee' Text='2.00' />保留小数点后两位数字,选输</td>
            </tr> 
            <tr>
                <td>证件号码</td>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtInstallmentMark' Text='1' />1：分期；0：否。*必输</td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtInstallmentCode' Text='00011111' />*必输</td>
            </tr>
            <tr>
                <td>分期期数
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtInstallmentNum' Text='10' />2-99,*必输</td>
            </tr>
            <tr>
                <td>交易渠道
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtBuyIP' Text='255.255.255.255' />选输</td>
            </tr>
            <tr>
                <td>订单保存时间
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtReceiveAccount' Text='5555555555555555' />选输</td>
            </tr>
            <tr>
                <td>收款方户名
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtReceiveAccName' Text='测试' />选输</td>
            </tr>
            <tr>
                <td>附言
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtMerchantRemarks' Text='Hi' />不超过100个字符，选输</td>
            </tr>
            <tr>
                <td>交易是否分账
                </td>
                <td>
                    <asp:TextBox runat="server" ID='txtIsBreakAccount' Text='1' />0:否；1:是，选输</td>
            </tr>            
			 <tr>
                <td>分账模版编号</td>
                <td>
