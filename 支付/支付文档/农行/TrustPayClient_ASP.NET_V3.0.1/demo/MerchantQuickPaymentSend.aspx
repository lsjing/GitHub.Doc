    ...
    <form id="form1" runat="server">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtAccName' Text='Name' />选输</td>
            </tr>
            <tr>
                <td>证件类型
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtCertificateID' Text='001' />选输</td>
            </tr>
            <tr>
                <td>卡有效期
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtPaymentType' Text='3' />1：农行卡支付 3：农行贷记卡支付 A:支付方式合并 *必输</td>
            </tr>
            <tr>
                <td>交易渠道
                </td>
            ...
            <tr>
                ...
                <td>
                    <asp:TextBox runat="server" ID='txtMerchantRemarks' Text='Hi!' />选输</td>
            </tr>
            <tr>
                <td colspan="2">
