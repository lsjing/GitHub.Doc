...
<script runat="server">
    ...
    protected void btnButton_Click(object sender, EventArgs e)
    {
        ...
        if (ReturnCode.Equals("0000"))
        {
            ...
            strMessage.Append("SettleType      = [" + JSON.GetKeyValue("SettleType") + "]<br/>");
            strMessage.Append("NumOfPayments      = [" + JSON.GetKeyValue("NumOfPayments") + "]<br/>");
            strMessage.Append("SumOfPayAmount      = [" + JSON.GetKeyValue("SumOfPayAmount") + "]<br/>");
            strMessage.Append("NumOfRefunds      = [" + JSON.GetKeyValue("NumOfRefunds") + "]<br/>");
            strMessage.Append("SumOfRefundAmount      = [" + JSON.GetKeyValue("SumOfRefundAmount") + "]<br/>");
            strMessage.Append("ZIPDetailRecords      = [" + JSON.GetKeyValue("ZIPDetailRecords") + "]<br/>");
