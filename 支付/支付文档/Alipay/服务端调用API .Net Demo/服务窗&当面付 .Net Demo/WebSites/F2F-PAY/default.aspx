<%@ Page Language="C#" AutoEventWireup="true" CodeFile="default.aspx.cs" Inherits="F2FPay._Default" %>
        ...
        <div id="main">
            ...
            <div id="body" style="clear: left">
                <dl class="content">
                    ...
                    <dd>
                        <span class="null-star">*</span>
                        <asp:TextBox ID="WIDdynamic_id_type" name="WIDdynamic_id_type" runat="server"></asp:TextBox>
                        <span>wave_code：声波，bar_code：条码
</span>
                    </dd>
                    <dt>动态ID：</dt>
                    <dd>
