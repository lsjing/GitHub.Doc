...
'/////////////////////请求参数/////////////////////
        ...
        '支付宝交易号与商户订单号不能同时为空
        '商户订单号
        out_order_no = Request.Form("WIDout_order_no")

'/////////////////////请求参数/////////////////////

'构造请求参数数组
sParaTemp = Array("service=close_trade","partner="&partner,"_input_charset="&input_charset  ,"trade_no="&trade_no   ,"out_order_no="&out_order_no  )
